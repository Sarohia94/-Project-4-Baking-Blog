# Generated by Django 3.2.19 on 2023-05-17 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_equipment', models.CharField(blank=True, max_length=150)),
                ('method', models.TextField()),
                ('bakers_tip', models.CharField(blank=True, max_length=200)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('status', models.IntegerField(choices=[(0, 'Draft'), (1, 'Published')], default=0)),
